...
Page({
  ...
  translateText: function(item, index) {
    ...
    if("宝宝七夕快乐"==item.text){
      this.AudioContext("党伟玥宝宝个大傻逼，哈哈哈哈哈哈哈哈哈，不玩花腔，只是认真的传个短信给你，我爱你哟宝宝,情人节快乐，嘻嘻嘻嘻嘻~。")
      let tmpTranslate = Object.assign({}, item, {
        autoPlay: true, // 自动播放背景音乐
        translateText: "党伟玥宝宝个大傻逼，哈哈哈哈哈哈哈哈哈，不玩花腔，只是认真的传个短信给你，我爱你哟宝宝,情人节快乐♡♡♡ 嘻嘻嘻嘻嘻~",
        record1 : 1
      })
    ...
    this.scrollToNew();
      ...
      getChat({
        ...
        if(res.data.data.state == "CLARIFY"){
          this.setData({
